...
ActiveRecord::Schema.define(version: 20170214160114) do
  ...
  add_index "spree_delivery_slots", ["deleted_at"], name: "index_spree_delivery_slots_on_deleted_at", using: :btree
  add_index "spree_delivery_slots", ["shipping_method_id"], name: "index_spree_delivery_slots_on_shipping_method_id", using: :btree
  ...
  create_table "spree_payments", force: :cascade do |t|
    ...
    t.string   "account_no",               limit: 255
    t.string   "transaction_reference_no", limit: 255
    t.date     "deposited_on"
  end
  ...
  create_table "spree_shipments", force: :cascade do |t|
    ...
    t.decimal  "taxable_adjustment_total",                 precision: 10, scale: 2, default: 0.0, null: false
    t.decimal  "non_taxable_adjustment_total",             precision: 10, scale: 2, default: 0.0, null: false
    t.integer  "delivery_slot_id",             limit: 4
  end

  add_index "spree_shipments", ["address_id"], name: "index_spree_shipments_on_address_id", using: :btree
  add_index "spree_shipments", ["delivery_slot_id"], name: "index_spree_shipments_on_delivery_slot_id", using: :btree
